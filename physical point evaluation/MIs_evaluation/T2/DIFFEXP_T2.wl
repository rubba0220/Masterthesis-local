...
misnorm = Import["masters_T2_norm.m"];
...
boundary=Get["../../boundary/T2/bound_Num_T2.m"];


(*Loading polynomial set for the analytic continuation of topology T2*)


AC=Get["Analytic_Continuation_T2.m"];
...
dijvalues = SetPrecision[Get["C:/Users/Laptop von Ruben/Desktop/Masterthesis local/physical point evaluation/dij.m"],16]
point1=<|dijvalues[[1]],dijvalues[[2]],dijvalues[[3]],dijvalues[[4]],dijvalues[[5]],dijvalues[[6]]|>
...
perm1=permutations[[2]][[1]];


mastersnorm = Get["masters_T2.m"];
mastersnorm = Get["masters_T2_norm.m"] /. ResultsP1[[1]] /. Rule[a_,b_]:>Sqrt[b];
...
Export["Numerics/resT2_p12345.m",masterrulesP1];
...
inv0=InvariantsPermutations[[2,2]]/.mmp[p4,p3]->d34/.mmp[p5,p4]->d45;
inv1=inv0[[All,1]];
...
perm2=permutations[[2]][[2]];


mastersnorm = Get["masters_T2.m"];
mastersnorm = Get["masters_T2_norm.m"] /. ResultsP2[[1]] /. Rule[a_,b_]:>Sqrt[b];
...
Export["Numerics//resT2_p12354.m",masterrulesP2];
...
inv0=InvariantsPermutations[[2,3]]/.mmp[p4,p3]->d34/.mmp[p5,p4]->d45;
inv1=inv0[[All,1]];
inv2=inv0[[All,2]]/.sijreplace/.point1;
...
perm3=permutations[[2]][[3]];


mastersnorm = Get["masters_T2.m"];
mastersnorm = Get["masters_T2_norm.m"] /. ResultsP3[[1]] /. Rule[a_,b_]:>Sqrt[b];
...
Export["Numerics/resT2_p12435.m",masterrulesP3];
...
inv0=InvariantsPermutations[[2,4]]/.mmp[p5,p3]->d35/.mmp[p5,p4]->d45;
inv1=inv0[[All,1]];
inv2=inv0[[All,2]]/.sijreplace/.point1;
...
perm4=permutations[[2]][[4]];


mastersnorm = Get["masters_T2.m"];
mastersnorm = Get["masters_T2_norm.m"] /. ResultsP4[[1]] /. Rule[a_,b_]:>Sqrt[b];
...
Export["Numerics/resT2_p12453.m",masterrulesP4];
...
inv0=InvariantsPermutations[[2,5]]/.mmp[p4,p3]->d34/.mmp[p5,p4]->d45;
inv1=inv0[[All,1]];
inv2=inv0[[All,2]]/.sijreplace/.point1;
...
perm5=permutations[[2]][[5]];


mastersnorm = Get["masters_T2.m"];
mastersnorm = Get["masters_T2_norm.m"] /. ResultsP5[[1]] /. Rule[a_,b_]:>Sqrt[b];
...
Export["Numerics/resT2_p12543.m",masterrulesP5];
...
perm6=permutations[[2]][[6]];


mastersnorm = Get["masters_T2.m"];
mastersnorm = Get["masters_T2_norm.m"] /. ResultsP6[[1]] /. Rule[a_,b_]:>Sqrt[b];
...
Export["Numerics/resT2_p12534.m",masterrulesP6];
