...
(*The boundary values for the MIs f3,f7,f12 and f14 in topology T3 are obtained from the values of the MIs f4,f8,f11 and f14 in permutation P6 of topology T1*)
...
(*Generate the point "pointP2" in which the boundary are computed for permutation P2 of topology T2*)


inv0=InvariantsPermutations[[2,2]]/.mmp[p4,p3]->d34/.mmp[p5,p4]->d45;
inv1=inv0[[All,1]];
inv2=inv0[[All,2]]/.sijreplace/.point;
pointP2=Inner[Rule,inv1,inv2,List]


(*In order to avoid singularities along the integration path we first transport the boundary values to a different point, "pointP2AUX"*)


pointP2AUX={d12->-2,d23->-2,d34->5,d45->-2,d15->2,mt2->1};


ResultsP2AUX=TransportTo[DiffExpBC,pointP2AUX];


(*Transport the values of the boundary conditions to the point "pointP2"*)


ResultsP2=TransportTo[ResultsP2AUX,pointP2];


(*The boundary values for the MI f11 in topology T3 is obtained from the values of the MIs f15 in permutation P2 of topology T2*)
...
(*The boundary values for the MI f10 in topology T3 is obtained from the values of the MIs f9 in permutation P6 of topology T2*)
...
(*Create complete list of new boundary values for topology T3*)


listT3Prec={boundAnNum[[1]],boundAnNum[[2]],b[3],boundAnNum[[3]],b[5],boundAnNum[[4]],b[7],boundAnNum[[5]],boundAnNum[[6]],b[10],b[11],b[12],boundAnNum[[7]],b[14],boundAnNum[[8]],boundAnNum[[9]],boundAnNum[[10]]};


(*Loading boundary values evaluated with 100 digits accuracy*)


boundOG=Get["bound_Num_T3.m"];


(*Comparison between the new evaluation and the 100 digits one*)


Chop[listT3Prec-boundOG,10^(-4)]


Export["listT3Prec.m",listT3Prec];
