...
rot1v = N[Rot[SetPrecision[0.3,50],SetPrecision[0.3,50],SetPrecision[0.8,50]],50];
...
e3mp = eval[a3mp];
e4mp = eval[a4mp];
Print["partial amp = ", e1mp];

e1pm = phasepm*theta . (e1mp // Normal)[[All,2]];
e2pm = phasepm*theta . (e2mp // Normal)[[All,2]];
e3pm = phasepm*theta . (e3mp // Normal)[[All,2]];
e4pm = phasepm*theta . (e4mp // Normal)[[All,2]];
